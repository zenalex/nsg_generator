...
Важные замечания:
> Если для произвольного объекта не нужно генерировать дополнительных полей, оставьте в описании пустой список (```"fields": []```)

> Естественно, копировать поля базового типа в производные НЕ НУЖНО!
