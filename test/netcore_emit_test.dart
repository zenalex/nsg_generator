  ...
  group('NsgGenNetcore — AppDbContext (раунд 3.А)', () {
    ...
    test('Program.cs: byte-identical (no implicit usings — explicit using-list)', () {
      ...
      const expected = 'using Microsoft.AspNetCore.Builder;\n'
          ...
          '// TASK06 §6.3: auth-инфра (JWT + custom NsgRawToken handler) регистрируется\n'
          '// внутри AddNsgGeneratedServices — там же читается секция Jwt из конфига.\n'
          'builder.Services.AddNsgGeneratedServices(builder.Configuration);\n'
