...
///
/// КОНТРОЛЬНЫЕ ЗНАЧЕНИЯ (baseline, Dart SDK 3.x):
///   - F:/Project2/flutter2/FootballersDiary_Server/FootballersDiary/GeneratorConfig
///     (310 файлов) → `84af1356e618e48b`
/// При любой правке `_normalize`/`canonicalizeJson` — пересчитать на этом корпусе
/// и обновить значения здесь и в TASK01.md. Если изменение хеша было НЕ намеренным
/// (рефакторинг без смысловой правки) — это баг канонизации, фиксить до мерджа.
/// Эмпирическая сверка Dart 2.18 vs Dart 3 — обязательство, не выполнено
/// (Dart 2 SDK локально не установлен на момент написания).
///
